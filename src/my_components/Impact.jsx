...
export function Impact_1() {
    return (
        <div className="bg-cover bg-center" style={{ backgroundImage: "url('/bgs/2.png')" }}>
            ...
            <div className="lg:w-1/2 w-full p-4 lg:ml-16">
                <div className="text-gray-700 mb-4">
                    <div className="font-semibold mb-2 text-4xl text-">Fuel Savings:</div>
...
export function Impact_2() {
    return (
        <div className="bg-cover bg-center" style={{ backgroundImage: "url('/bgs/3.png')" }}>
         <div className="flex flex-col lg:flex-row justify-center items-center p-8">
            <div className="lg:w-1/2 w-full flex justify-center items-center">
...
export function Impact_3() {
    return (
        <div className="bg-cover bg-center" style={{ backgroundImage: "url('/bgs/4.png')" }}>
            <div className="flex flex-col lg:flex-row justify-center items-center p-8">
            <div className="lg:w-1/2 w-full p-4 lg:ml-16">
                <div className="text-xl text-gray-700 mb-4">
